describe("The apple seller functions", function() {
	...
	it("should be able to calculate the total profit from apples sold", function() {
		...
		assert.equal(12.05, totalProfit(applesSoldList1, applePrices1));
		assert.equal(11.45, totalProfit(applesSoldList2, applePrices2));
	...
	//it("should be able to calculate the total number of each color sold", function() {
		...
		// for(let i = 0; i < applesSoldList1.length; i++) {
		// 	let currentApple = applesSoldList1[i];
		...
		// 	if(key == 'green') {
		// 		console.log(colorsAdded[key])
		// 	}
		// }
		
		
		//assert.equal(1, totalPerColorSold(applesSoldList1, 'green'));
	...
	// 	assert.equal(12.05, totalProfitPerColor(applesSoldList1, 'red', applePrices1));
